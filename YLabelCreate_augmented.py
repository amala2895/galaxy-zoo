...
def ylabel_augmented():
    ...
    for row in reader:
        ...
        #print("appending")
        imageID_1=imageID+"_1"
        imageID_2=imageID+"_0"
       
        label_ids.append(imageID_1)
        label_ids.append(imageID_2)
        label_values[imageID_1] = newRow
        label_values[imageID_2] = newRow
        label_values[imageID] = newRow
...
def getYlabel(no_train, no_val,augmentation):
    label_values = {}
    label_ids=[]
    if(augmentation):
        label_ids, label_values=ylabel_augmented()
    else:
