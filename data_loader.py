...
def loader(label_ids, label_values, crop_size, resolution, batch_size, shuffle, questions,transforms1=None):
    ...
    class Dataset(data.Dataset):
      #'Characterizes a dataset for PyTorch'
        def __init__(self, list_IDs, labels, image_folder, crop_size, resolution, questions, transforms1):
            'Initialization'
            self.labels = labels
    ...
    data_set = Dataset(label_ids, label_values, image_folder, crop_size, resolution, questions, transforms1)
